(function (global) {
    ...
    function directoryNotesFromTree(node, rootName) {
        ...
        const note = {
            ...
            security: node.security || null, // SOFTM-publishing-github 2026-07-09: 화면에서 퍼블리싱 상태를 판단하도록 디렉터리 보안 메타 전달
            child_directories: childDirs.map(child => ({
                ...
                security: child.security || null // SOFTM-publishing-github 2026-07-09: 하위 디렉터리 퍼블리싱 상태 표시용 보안 메타 전달
            })),
            ...
            file_details: childFiles.map(child => ({
                ...
                security: child.security || null // SOFTM-publishing-github 2026-07-09: 파일 퍼블리싱 상태 표시용 보안 메타 전달
            }))
        };
    ...
    function attachmentsFromIndex(index) {
        ...
        return files.map(file => {
            ...
            return {
                ...
                security: file.security || null // SOFTM-publishing-github 2026-07-09: 자료실 첨부 퍼블리싱 상태 표시용 보안 메타 전달
            };
        });
    }
