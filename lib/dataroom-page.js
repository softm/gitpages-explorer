;(function (window, document) {
    ...
    function getSearchStateParams(viewerItem) {
        ...
        } // SOFTM-publishing-condition-filter 2026-07-10: 자료실 URL에 게시 상태 조건 저장
        if (selectedListKey) {
    ...
    function getTotalFilterCount(scope) {
        ...
        const publishingFilter = getPublishingFilterValue();
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        Promise.all([publishingReady, window.FilesIndexUtils.loadIndex('files.json')])
            .then(([, data]) => {
                ...
                } // SOFTM-publishing-condition-filter 2026-07-10: 자료실 게시 상태 조건 변경 시 검색 갱신
                ...
                const applyUrlState = (urlParams) => {
                    ...
                    setPublishingFilterValue(urlParams.get('publish') || 'all');
                    const loadedTypeFilter = document.getElementById('loadedTypeFilter');
                    if (loadedTypeFilter) {
