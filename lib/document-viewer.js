(function (window, document) {
    ...
    function createFullscreenButton(target, options) {
        ...
        const update = () => {
            ...
            const active = Boolean(element && getFullscreenElement() === element);
        ...
        button.addEventListener('click', () => {
            ...
            if (getFullscreenElement() === element) {
                exitFullscreen().catch(error => console.error('Error attempting to exit fullscreen:', error));
                return;
            }
            requestFullscreen(element).catch(error => console.error('Error attempting to enable fullscreen:', error));
        });
