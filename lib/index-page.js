(function (window, document) {
    ...
    function createNoteListSection(label) {
        const li = document.createElement('li');
        li.className = 'note-list-section';
