(function (window, document) {
    ...
    function openDirectoryViewer(section, selectedItem, options = {}) {
        ...
        railToggleButton.className = 'directory-viewer-rail-toggle';
        railToggleButton.textContent = '목록';
        ...
        navControls.appendChild(railToggleButton);
        ...
        const syncRailToggle = () => {
            ...
            railToggleButton.textContent = expanded ? '목록 닫기' : '목록';
        };
        ...
        items.forEach((item, index) => {
            ...
            button.addEventListener('click', () => {
                selectedIndex = index;
                render();
                if (isMobilePreviewSheetViewport()) {
                    viewer.classList.remove('is-rail-open');
                    syncRailToggle();
                }
