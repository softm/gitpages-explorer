    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        Promise.all([publishingReady, window.FilesIndexUtils.loadIndex('files.json')])
            .then(([, data]) => {
                ...
                const publishingFilterParam = urlParams.get('publish'); // SOFTM-publishing-condition-filter 2026-07-10: URL 게시 상태 조건 복원
                ...
                if (searchQuery || publishingFilterParam || imageFilterParam || videoFilterParam || audioFilterParam || documentFilterParam) {
                    setLeftMenuTab('search');
                    searchFiles();
                } else {
        ...
        const mainPublishingFilter = document.getElementById('mainPublishingFilter');
        ...
        const searchPublishingFilter = document.getElementById('searchPublishingFilter');
